...
void
gypsy_marshal_VOID__INT_INT_DOUBLE_DOUBLE_DOUBLE (GClosure     *closure,
                                                  ...
                                                  gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_INT_DOUBLE_DOUBLE_DOUBLE) (gpointer     data1,
                                                                   ...
                                                                   gdouble      arg_5,
                                                                   gpointer     data2);
  register GMarshalFunc_VOID__INT_INT_DOUBLE_DOUBLE_DOUBLE callback;
...
void
gypsy_marshal_VOID__INT_DOUBLE_DOUBLE_DOUBLE (GClosure     *closure,
                                              GValue       *return_value G_GNUC_UNUSED,
                                              guint         n_param_values,
                                              const GValue *param_values,
                                              gpointer      invocation_hint G_GNUC_UNUSED,
                                              gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_DOUBLE_DOUBLE_DOUBLE) (gpointer     data1,
                                                               gint         arg_1,
                                                               gdouble      arg_2,
                                                               gdouble      arg_3,
                                                               gdouble      arg_4,
                                                               gpointer     data2);
  register GMarshalFunc_VOID__INT_DOUBLE_DOUBLE_DOUBLE callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__INT_DOUBLE_DOUBLE_DOUBLE) (marshal_data ? marshal_data : cc->callback);
